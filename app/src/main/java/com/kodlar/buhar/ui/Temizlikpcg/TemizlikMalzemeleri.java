    ...
    public void onStart(){
        ...
        FirebaseRecyclerOptions options=
                new FirebaseRecyclerOptions.Builder<Urun1>()
                        .setQuery(TemizlikMalzemeleriRef, Urun1.class)
                        .build();

        final FirebaseRecyclerAdapter<Urun1, TemizlikMalzemeleriViewHolder> adapter = new FirebaseRecyclerAdapter<Urun1, TemizlikMalzemeleriViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final TemizlikMalzemeleriViewHolder TemizlikMalzemeleriViewHolder, int i, @NonNull Urun1 urun) {
                ...
                TemizlikMalzemeleriRef.child(userIDs).addValueEventListener(new ValueEventListener(){
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        ...
                        TemizlikMalzemeleriViewHolder.sepetArti.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                TemizlikMalzemeleriViewHolder.miktar++;

                                SepetRef.child(userIDs).setValue(new Urun1(urunadi, urunagirlik, urunfiyat, urunfotografi, urunid));
                                SepetRef.child(userIDs).child("miktar").setValue(TemizlikMalzemeleriViewHolder.miktar);
                                SepetRef.child(userIDs).child("uruntutari").setValue(urun.getUruntutari());
                                Snackbar.make(TemizlikMalzemeleriView, "Sepetinize ürün eklendi.", Snackbar.LENGTH_LONG)
                                        .setAction("Action", null).show();


                                urun.setUruntutari(TemizlikMalzemeleriViewHolder.miktar * urunfiyat);
