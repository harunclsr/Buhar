    ...
    public void onStart(){
        ...
        FirebaseRecyclerOptions options=
                new FirebaseRecyclerOptions.Builder<Urun1>()
                        .setQuery(KuruyemisRef, Urun1.class)
                        .build();

        final FirebaseRecyclerAdapter<Urun1, KuruyemisViewHolder> adapter = new FirebaseRecyclerAdapter<Urun1, KuruyemisViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final KuruyemisViewHolder KuruyemisViewHolder, int i, @NonNull Urun1 urun) {
                ...
                KuruyemisRef.child(userIDs).addValueEventListener(new ValueEventListener(){
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        ...
                        KuruyemisViewHolder.sepetArti.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                KuruyemisViewHolder.miktar++;

                                SepetRef.child(userIDs).setValue(new Urun1(urunadi, urunagirlik, urunfiyat, urunfotografi, urunid));
                                SepetRef.child(userIDs).child("miktar").setValue(KuruyemisViewHolder.miktar);
                                SepetRef.child(userIDs).child("uruntutari").setValue(urun.getUruntutari());
                                Snackbar.make(KuruyemisView, "Sepetinize ürün eklendi.", Snackbar.LENGTH_LONG)
                                        .setAction("Action", null).show();


                                urun.setUruntutari(KuruyemisViewHolder.miktar * urunfiyat);
