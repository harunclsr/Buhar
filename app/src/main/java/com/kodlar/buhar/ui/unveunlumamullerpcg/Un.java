    ...
    public void onStart(){
        ...
        FirebaseRecyclerOptions options=
                new FirebaseRecyclerOptions.Builder<Urun1>()
                        .setQuery(UnRef, Urun1.class)
                        .build();

        final FirebaseRecyclerAdapter<Urun1, UnViewHolder> adapter = new FirebaseRecyclerAdapter<Urun1, UnViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final UnViewHolder UnViewHolder, int i, @NonNull Urun1 urun) {
                ...
                UnRef.child(userIDs).addValueEventListener(new ValueEventListener(){
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        ...
                        UnViewHolder.sepetArti.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                SepetRef.child(userIDs).child("miktar").setValue(UnViewHolder.miktar);
                                SepetRef.child(userIDs).child("uruntutari").setValue(urun.getUruntutari());
                                Snackbar.make(unView, "Sepetinize ürün eklendi.", Snackbar.LENGTH_LONG)
                                        .setAction("Action", null).show();


                                urun.setUruntutari(UnViewHolder.miktar * urunfiyat);
